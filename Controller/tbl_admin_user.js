...
const updateAdminUser = async(req,res) =>{
    try{
        let sqlQuery = "UPDATE tbl_admin_user SET name = ?, email = ?, password = ?, mobile = ?, photo = ?, aadhar = ?, doj = ?, qualification = ?, dob = ?, state = ?, address = ?, city = ?, pin = ?, status = ? WHERE id= ?" ;
...
const deleteAdminUser = (req,res) =>{
    try{
        const sqlQuery = "DELETE from tbl_admin_user WHERE id = ?";
